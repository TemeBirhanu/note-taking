...
state = dispatchAction(state, { type: 'LOGIN_SUCCESS', payload: { user: { id: 'u1', username: 'alice', email: 'alice@mail.com' }, token: 'tok' } }, log);
state = dispatchAction(state, { type: 'UPDATE_USER', payload: { username: 'alice2' } }, log);
